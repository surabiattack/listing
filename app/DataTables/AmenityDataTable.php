    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $edit = '<a href="' . route('admin.amenity.edit', $query->id) . '" class="btn btn-primary"><i class="fas fa-edit"></i></a>';
                $delete = '<a href="' . route('admin.amenity.destroy', $query->id) . '" class="delete-item btn btn-danger ml-2"><i class="fas fa-trash"></i></a>';
                return $edit . $delete;
            })
